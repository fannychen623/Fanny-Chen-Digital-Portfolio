...
const urlPrefix = 'https://github.com/fannychen623/Fanny-Chen-Digital-Portfolio/blob/main/src/assets/stepItUp/';
const urlSuffix = '?raw=true';

const stepItUp = [
  {
    originalTitle: 'Step-It-Up',
    ...
    original: `${urlPrefix}homePage2.png${urlSuffix}`,
    thumbnail: `${urlPrefix}homePage2.png${urlSuffix}`,
    // originalHeight: '20px',
    // originalWidth: '220px', 
